...
This is done by ppassing data and control information between stages in the pipeline using internal registers called **Pipeline registers** or **register latches**. At the end of each clock cycle, data resulting from the operations of the pipeline stages would be available in the pipeline registers. 
